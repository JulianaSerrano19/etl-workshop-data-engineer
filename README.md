...
* **Aplicación de la Regla de Contratación ("HIRED"):** Un candidato se marca como contratado (is_hired = 1) si y solo si:
...
* **Modelado Dimensional y Mapeo:** Se extraen los valores únicos para generar las tablas de dimensión normalizadas (dim_candidate, dim_location, dim_technology, dim_seniority, dim_date). Se generan claves subrogadas autoincrementables (_id) para cada dimensión y se mapean de regreso a la tabla de hechos central (fact_applications).
